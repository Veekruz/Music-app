...
// Renamed the main component to avoid conflict
export default function MusicApp() {
  const [songs, setSongs] = useState([]);
  const [searchTerm, setSearchTerm] = useState("khalid");
    ...
    <BrowserRouter>
      <div style={styles.body}>
        ...
        <div style={styles.header}>
          <h1 style={styles.h1}>Music Explorer</h1>
...
// Home Page Component
function HomePage({ songs, loading, searchTerm, setSearchTerm, fetchMusic }) {
  return (
    <>
      {/* Search Bar */}
      <div style={styles.searchContainer}>
        <div style={styles.searchBar}>
          <input
            ...
            onKeyPress={(e) => e.key === 'Enter' && fetchMusic()}
            style={styles.input}
          />
